...
export class MyApp {
	...
	initializeOnymosComponents() {
		...
		let onymosConnectObj = {
			customerId : 'O1000002387', // Obtain at Account > Settings
			onymosAuthToken : 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MDk0ODc5OTksInYiOjAsImQiOnsidWlkIjoiTzEwMDAwMDIzODcifSwiaWF0IjoxNTA3MzgxMTU1fQ.nK_wBzoB0sj4vY5GLyDMMiGsW9CSmhW32eSX5UhRIqw',
			envType : 'PRD'
		};
